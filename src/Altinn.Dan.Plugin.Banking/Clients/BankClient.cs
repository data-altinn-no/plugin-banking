...
namespace Altinn.Dan.Plugin.Banking.Clients
{
    ...
    public partial class Bank
    {
        ...
        /// <summary>List of accounts for a specified party and period. Account number can be provided in place of the party identifier for lookup requests directly on the account. Must provide a blank list if no hits.</summary>
        ...
        /// <param name="accountID">The account number. Not in use per now.</param>
        ...
        /// <returns>Valid response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Accounts> ListAccountsAsync(System.Guid accountInfoRequestID, System.Guid correlationID, string legal_Mandate, string partyID, string accountID, string additionalReferenceID, AdditionalReferenceIDType? additionalReferenceIDType, System.DateTimeOffset? fromDate, System.DateTimeOffset? toDate, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    request_.Headers.Accept.Add(System.Net.Http.Headers.MediaTypeWithQualityHeaderValue.Parse("application/jose,application/json"));
        ...
        /// <summary>Account details, including balances, for an account</summary>
        ...
        /// <returns>Valid response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<AccountDetails> ShowAccountByIdAsync(string accountReference, System.Guid accountInfoRequestID, System.Guid correlationID, string legal_Mandate, string additionalReferenceID, AdditionalReferenceIDType2? additionalReferenceIDType, System.DateTimeOffset? fromDate, System.DateTimeOffset? toDate, System.Threading.CancellationToken cancellationToken)
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new ApiException<Error404>("ACC-002 or ACC-003 and the best possible description of the error from Data Provider. See information regarding specific error situations on github under API-spesification for the different ACC codes.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 405)
                        {
        ...
        /// <summary>Transactions for specified account and period. Empty list if no hits. Must support pagination on large result sets (min 1000) - see separate description in the link element.</summary>
        /// <param name="accountReference">Unique reference to the account. Shall match the account number.</param>
        /// <param name="accountInfoRequestID">Unique reference number / case number that follows the case throughout the different requests.</param>
        /// <param name="correlationID">Correlation ID, unique identifier for the technical request</param>
        /// <param name="legal_Mandate">The Legal basis used by data consumers in order to fetch data. Should be validated by the data provider.</param>
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Transactions> ListTransactionsAsync(string accountReference, System.Guid accountInfoRequestID, System.Guid correlationID, string legal_Mandate, string additionalReferenceID, AdditionalReferenceIDType3? additionalReferenceIDType, System.DateTimeOffset? fromDate, System.DateTimeOffset? toDate)
        {
        ...
        /// <returns>A list of transactions</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Transactions> ListTransactionsAsync(string accountReference, System.Guid accountInfoRequestID, System.Guid correlationID, string legal_Mandate, string additionalReferenceID, AdditionalReferenceIDType3? additionalReferenceIDType, System.DateTimeOffset? fromDate, System.DateTimeOffset? toDate, System.Threading.CancellationToken cancellationToken)
        {
            if (accountReference == null)
                throw new System.ArgumentNullException("accountReference");
        ...
        /// <summary>List of cards associated with the specified account. Empty list if no hits.</summary>
        ...
        /// <returns>Valid response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Cards> ListCardsAsync(string accountReference, System.Guid accountInfoRequestID, System.Guid correlationID, string legal_Mandate, string additionalReferenceID, AdditionalReferenceIDType4? additionalReferenceIDType, System.DateTimeOffset? fromDate, System.DateTimeOffset? toDate, System.Threading.CancellationToken cancellationToken)
        {
            if (accountReference == null)
                throw new System.ArgumentNullException("accountReference");
        ...
        /// <summary>Role holders for the specified account. Empty list if no hits.</summary>
        /// <param name="accountReference">Unique reference to the account. Shall not match the account number.</param>
        /// <param name="accountInfoRequestID">Unique reference number / case number that follows the case throughout the different requests.</param>
        /// <param name="correlationID">Correlation ID, unique identifier for the technical request</param>
        /// <param name="legal_Mandate">The Legal basis used by data consumers in order to fetch data. Should be validated by the data provider.</param>
        ...
        /// <returns>Valid response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Roles> ListRolesAsync(string accountReference, System.Guid accountInfoRequestID, System.Guid correlationID, string legal_Mandate, string additionalReferenceID, AdditionalReferenceIDType5? additionalReferenceIDType, System.DateTimeOffset? fromDate, System.DateTimeOffset? toDate)
        {
        ...
        /// <returns>Valid response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Roles> ListRolesAsync(string accountReference, System.Guid accountInfoRequestID, System.Guid correlationID, string legal_Mandate, string additionalReferenceID, AdditionalReferenceIDType5? additionalReferenceIDType, System.DateTimeOffset? fromDate, System.DateTimeOffset? toDate, System.Threading.CancellationToken cancellationToken)
        {
            if (accountReference == null)
                throw new System.ArgumentNullException("accountReference");
    ...
    public partial class AccountDetail
    {
        ...
        [Newtonsoft.Json.JsonProperty("startDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, DefaultValueHandling = Newtonsoft.Json.DefaultValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(DateFormatConverter))]
        public System.DateTimeOffset StartDate { get; set; }

        [Newtonsoft.Json.JsonProperty("endDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, DefaultValueHandling = Newtonsoft.Json.DefaultValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(DateFormatConverter))]
    ...
    public partial class Balance
    {
        ...
        [Newtonsoft.Json.JsonProperty("registered", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, DefaultValueHandling = Newtonsoft.Json.DefaultValueHandling.Ignore)]
    ...
    public partial class Transaction
    {
        ...
        [Newtonsoft.Json.JsonProperty("bookingDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, DefaultValueHandling = Newtonsoft.Json.DefaultValueHandling.Ignore)]
        public System.DateTimeOffset BookingDate { get; set; }

        [Newtonsoft.Json.JsonProperty("valueDate", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore, DefaultValueHandling = Newtonsoft.Json.DefaultValueHandling.Ignore)]
